...
public class DrawerMechNotificationsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ((MechMainActivity) getActivity()).getSupportActionBar().setTitle("Notifications");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference()
                .child("Notification Collection").child("Mechanic").child(uid);

        progressDialog = new ProgressDialog(getContext());
        progressDialog.setMessage("Notifications loading...");
